...
;!E("Android")||G();G();E("Safari")&&(G()||(F()?0:E("Coast"))||(F()?0:E("Opera"))||(F()?0:E("Edge"))||(F()?D("Microsoft Edge"):E("Edg/"))||F()&&D("Opera"));var H=Math.max,fa=H.apply,I=Object.values({ca:1,aa:2,Z:4,fa:8,ea:16,da:32,U:64,ha:128,Y:256,X:512,ba:1024,V:2048,ga:4096,W:8192}),J;if(I instanceof Array)J=I;else{for(var ha=n(I),K,L=[];!(K=ha.next()).done;)L.push(K.value);J=L}fa.call(H,Math,J);function ia(){}
Object.freeze(new function(){});
Object.freeze(new ia);Object.freeze(new ia);function M(){this.s=this.s;this.B=this.B}
M.prototype.s=!1;M.prototype.dispose=function(){this.s||(this.s=!0,this.G())};
M.prototype.G=function(){if(this.B)for(;this.B.length;)this.B.shift()()};var N=u.window,ja,ka,O=(null==N?void 0:null==(ja=N.yt)?void 0:ja.config_)||(null==N?void 0:null==(ka=N.ytcfg)?void 0:ka.data_)||{};w("yt.config_",O);function P(a,b){return a in O?O[a]:b}
;function la(a,b){a=P("EXPERIMENT_FLAGS",{})[a];return void 0===a&&void 0!==b?b:Number(a||0)}
;var ma=la("web_emulated_idle_callback_delay",300),na=1E3/60-3,oa=[8,5,4,3,2,1,0];
...
g.G=function(){ua(this);U(this);this.v&&document.removeEventListener("visibilitychange",this.H);M.prototype.G.call(this)};var W=v("yt.scheduler.instance.timerIdMap_")||{},za=la("kevlar_tuner_scheduler_soft_state_timer_ms",800),X=0,Y=0;function Z(){var a=v("ytglobal.schedulerInstanceInstance_");if(!a||a.s)a=new Q(P("scheduler")||{}),w("ytglobal.schedulerInstanceInstance_",a);return a}
